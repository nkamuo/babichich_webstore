...
const getConfig = (pluginName, type) => {
    ...
    Encore
        ...
        .addEntry(`bitbag-${pluginName}-${type}`, path.resolve(__dirname, `./${type}/entry.js`))
...
Encore
    ...
    .addEntry(`bitbag-${pluginName}-shop`, path.resolve(__dirname, `./shop/entry.js`))
    .addEntry(`bitbag-${pluginName}-admin`, path.resolve(__dirname, `./admin/entry.js`))
    .cleanupOutputBeforeBuild()
    .disableSingleRuntimeChunk()
    .enableSassLoader();
